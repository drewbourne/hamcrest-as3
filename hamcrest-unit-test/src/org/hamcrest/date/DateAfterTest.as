package org.hamcrest.date {
    ...
    public class DateAfterTest extends AbstractMatcherTestCase {
        ...
        public function hasAReadableDescription():void {
            assertDescription("a date after <" + new Date( 1980, 1, 1 ) + ">", dateAfter(new Date( 1980, 1, 1 )) );
            assertDescription("a date after or equal to <" + new Date( 1980, 1, 1 ) + ">", dateAfterOrEqual(new Date( 1980, 1, 1 )));
        }
    }
}
