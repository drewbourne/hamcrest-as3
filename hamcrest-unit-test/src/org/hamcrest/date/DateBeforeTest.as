package org.hamcrest.date {
    ...
    public class DateBeforeTest extends AbstractMatcherTestCase {
        ...
        public function hasAReadableDescription():void {
            assertDescription("a date before <" + new Date( 2000, 1, 1) + ">", dateBefore(new Date( 2000, 1, 1)) );
            assertDescription("a date before or equal to <" + new Date( 2000, 1, 1) + ">", dateBeforeOrEqual(new Date( 2000, 1, 1)));
        }
    }
}
